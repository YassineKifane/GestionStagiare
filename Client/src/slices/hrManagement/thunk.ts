...
export const getEmployees = createAsyncThunk("hrManagement/getEmployee", async () => {
    try {
...
// this function is used to add itern
export const addIntern = createAsyncThunk("hrManagement/addEmployee", async (event: any) => {
    try {
