...
const Satisfaction = ({completedTasks}:any) => {
    return (
        <React.Fragment>
            <div className="order-9 col-span-12 lg:col-span-6 2xl:order-1 card 2xl:col-span-4">
                <div className="card-body">
                    <div className="flex items-center gap-2 mb-3">
                        <h6 className="text-15 grow">Completion Level <Link to="#!" data-tooltip="default" data-tooltip-content="The 1-to-5 satisfaction scale is used for measuring customer satisfaction" className="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500 dark:text-zink-200"><Info className="size-4"></Info></Link></h6>
                        <Dropdown className="relative dropdown shrink-0">
                            ...
                            <Dropdown.Content placement="right-end" className="absolute z-50 py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600" aria-labelledby="satisfactionRateDropdown">
                                <li>
                    ...
                    <SatisfactionChart data-chart-colors='["bg-custom-500"]' completedTasks={completedTasks} />
                    <p className="text-center text-15 text-slate-500 dark:text-zink-200">Completed Tasks 💖</p>
                </div>
            </div>
        </React.Fragment>
    );
